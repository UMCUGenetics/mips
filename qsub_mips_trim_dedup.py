...
if __name__ == "__main__":
    # Parse arguments
    if len(sys.argv) != 5:
        print "python qsub_mips_trim_dedup.py /path/to/design.txt uuid_length /path/to/raw_data/sequencer/run/Data/Intensities/BaseCalls /path/to/output/folder"
        sys.exit()
	...
	# Generate command and submit to cluster
        command = "python {0}/mips_trim_dedup.py {1} {2} {3} {4}".format(mips_trim_dedup_path, design_file, uuid_length, r1_fastq, r2_fastq)
